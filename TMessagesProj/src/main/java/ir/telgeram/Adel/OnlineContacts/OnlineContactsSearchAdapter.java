...
package ir.telgeram.Adel.OnlineContacts;
...
import ir.telgeram.Adel.Olds.BaseSearchAdapter;
import ir.telgeram.Adel.Olds.GreySectionCell;
...
public class OnlineContactsSearchAdapter extends BaseSearchAdapter
{
    ...
    public OnlineContactsSearchAdapter(Context context, HashMap<Integer, TLRPC.User> arg1, boolean usernameSearch, boolean mutual, boolean chats, boolean bots) {
        mContext = context;
        ignoreUsers = arg1;
        onlyMutual = mutual;
